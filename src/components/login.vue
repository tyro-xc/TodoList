<template>
  <div class="container">
    <el-form style="max-width: 300px" label-width="auto" class="demo-ruleForm" :model="loginData" v-if="isRegister"
      :rules="rules">
      <h3>Register</h3>
      ...
      <el-form-item style="display: flex; justify-content: center; align-items: center">
        ...
        <el-button type="reset" @click="resetLoginData">Reset</el-button>
      </el-form-item>
      <el-form-item>
    ...
    <el-form style="max-width: 300px" label-width="auto" class="demo-ruleForm" :model="loginData" v-else>
      <h3>login</h3>
      ...
      <el-form-item style="display: flex; justify-content: center; align-items: center">
        <el-button type="primary" @click="LoginHandler(loginData.username, loginData.password)"> Login </el-button>
        <el-button type="reset" @click="resetLoginData">Reset</el-button>
      </el-form-item>
...
const rules = {
  ...
  { min: 5, max: 16, message: "username length must be 5-16", trigger: "blur" }],
  password: [{ required: true, message: "password is required", trigger: "blur" },
  { min: 5, max: 16, message: "password length must be 5-16", trigger: "blur" }],
